...
export const metadata: Metadata = {
  title: "Code of Conduct | TitanSMP",
  description:
    "Community guidelines for respectful and inclusive interaction across TitanSMP spaces.",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    ...
    description:
      "Community guidelines for respectful and inclusive interaction across TitanSMP spaces.",
    type: "website",
    url: `${process.env.NEXT_PUBLIC_URL || "https://titansmp.de"}/code-of-conduct`,
  },
};
      ...
      <article className="mb-8 rounded-base border border-border/30 bg-secondary-background p-6 shadow-sm md:p-8">
        <section className="mb-6 rounded-base border border-border/30 bg-background p-5 shadow-sm">
          ...
          <p className="text-sm leading-relaxed md:text-base">
            We as the maintainer of TitanSMP, are committed to providing a
        ...
        <section className="mb-6 rounded-base border border-border/30 bg-background p-5 shadow-sm">
          ...
          <p className="text-sm leading-relaxed md:text-base">
            ...
            TitanSMP, and it also applies when an individual is representing the
            project or its community in public spaces. Examples of representing
