...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Get in touch with the TitanSMP team for network access, support, and community inquiries.",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Contact TitanSMP",
    description:
      "Reach the TitanSMP team for network access, support, and community inquiries.",
    type: "website",
    url: `${process.env.NEXT_PUBLIC_URL || "https://titansmp.de"}/contact`,
  },
};
